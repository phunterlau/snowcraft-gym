...
const MAP_DATA: Record<string, MapData> = {
  ...
  'arena6.json': {
    ...
    height: 48,
    objects: [
      { type: 'fort', x: -15, y: 0, width: 1.4, height: 12 },
      { type: 'fort', x: 15, y: 0, width: 1.4, height: 12 },
      { type: 'fort', x: 0, y: 0, width: 10, height: 1.2 },
      { type: 'fence', x: -7, y: -10, width: 8, height: 0.3 },
      { type: 'fence', x: 7, y: 10, width: 8, height: 0.3 },
      { type: 'fence', x: -7, y: 10, width: 8, height: 0.3 },
      { type: 'fence', x: 7, y: -10, width: 8, height: 0.3 },
      { type: 'tree', x: -20, y: -15 },
    ...
    spawns: [
      { team: Team.Player, x: -29, y: -18 },
      { team: Team.Player, x: -28, y: -14 },
      { team: Team.Player, x: -29, y: -10 },
      { team: Team.Player, x: -28, y: -6 },
      { team: Team.Player, x: -29, y: -2 },
      { team: Team.Player, x: -28, y: 2 },
      { team: Team.Player, x: -29, y: 6 },
      { team: Team.Player, x: -28, y: 10 },
      { team: Team.Player, x: -29, y: 14 },
      { team: Team.Player, x: -28, y: 18 },
      { team: Team.Enemy, x: 29, y: -18 },
      { team: Team.Enemy, x: 28, y: -14 },
      { team: Team.Enemy, x: 29, y: -10 },
      { team: Team.Enemy, x: 28, y: -6 },
      { team: Team.Enemy, x: 29, y: -2 },
      { team: Team.Enemy, x: 28, y: 2 },
      { team: Team.Enemy, x: 29, y: 6 },
      { team: Team.Enemy, x: 28, y: 10 },
      { team: Team.Enemy, x: 29, y: 14 },
